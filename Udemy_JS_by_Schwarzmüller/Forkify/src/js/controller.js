...
const renderSpinner = function (parentElement) {
    const markupContent = `<div class="spinner">
<svg>
  <use href="${icons}#icon-loader"></use>
</svg>
</div>`
    parentElement.innerHTML = ""
    parentElement.insertAdjacentHTML("afterbegin", markupContent)
}
...
const displayRecipe = async function () {
    try {
        ...
        recipeContainer.insertAdjacentHTML("afterbegin", makrupRecipe)
    } catch (error) {
        console.log(error)
    }
}
